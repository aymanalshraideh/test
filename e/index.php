        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid1" src="./assets/img/banner_img_01.jpg" alt="">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid1" src="./assets/img/banner_img_02.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid1" src="./assets/img/banner_img_03.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
...
foreach($data as $value):
		?>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./admin/categorys/public/<?php echo $value['category_image'];?>" class="rounded-circle img-fluid border"></a>
    ...
    <section class="bg-light">
        <div class="container py-5">
            ...
            <?php $select="SELECT  categories.category_name,products.product_main_image,products.product_price,products.product_description,products.product_name,products.product_id 
									FROM products LEFT JOIN categories ON categories.category_id = product_categorie_id LIMIT 3";
